...
def model_dir(robotname: str) -> Path:
    ...
    return Path(os.environ.get("MODEL_DIR", "sim/resources/") + robotname) # Pull from MODEL_DIR for file path to resources, or else default to ~/sim/reources/ . MAKE SURE MODEL_DIR has '/' at tail.
